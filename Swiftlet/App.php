...
class App implements Interfaces\App
{
	...
	public function run()
	{
		...
		$controllerFileName =  __DIR__ . '/../Swiftlet/Controllers/' . $controllerName . '.php';
		...
		// Load plugins
		if ( $handle = opendir(__DIR__ . '/../Swiftlet/Plugins') ) {
			while ( ( $file = readdir($handle) ) !== FALSE ) {
				if ( is_file(__DIR__ . '/../Swiftlet/Plugins/' . $file) && preg_match('/^(.+)\.php$/', $file, $match) ) {
